...
- `contracts/tui-rendering-v1.yaml` — Render pillar (M1 + M4-tests)
- `contracts/tui-lifecycle-v1.yaml` — React pillar (M2)
- `contracts/tui-panels-v1.yaml` — Compose pillar (M3 + M4-scene + M5)
